#python script using nornir_scrapli plugin "send_interactive"
#script will send interactive commands, in this case the script
#is designed to save the running configuration to flash using the
#filename goldimage1
