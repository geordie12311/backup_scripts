#python script using nornir scrapli that will prompt user to  enter show commands 
#then create an archive directory and save the output in date stamped files
import getpass
import pathlib
